# Markdown Feature Atlas

This starter file is a broad reference for the markdown and preview features built into markdownviewer.
This is a multi-line text test.  
This is a multi-line text test.\
This is a multi-line text test.

## Quick scan

- **Bold**, *italic*, ***bold italic***, ~~strikethrough~~, and `inline code`,||Hidden content||
...
- [ ] Open TODO list
- [x] Completed task
- [ ] Follow-up task with a [CommonMark reference](https://commonmark.org/help/)
...
![Claude](/image-material/claude color.svg)

![Gemini](/image-material/gemini-color.svg)

![grok](/image-material/grok.svg)

[![Deepseek](/image-material/deepseek-color.png)](https://www.deepseek.com/)

[![Kimi](/image-material/kimi-color.svg)](https://www.kimi.com/)

[![Qwen](/image-material/qwen-color.webp)](https://qwen.ai/home)
